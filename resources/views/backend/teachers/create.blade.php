...
@section('content')
    <div class="content-wrapper mt-0 px-2 py-2">
        ...
        <div class="index-box px-2 bg-white   py-4 mb-2" style="min-height: 530px; border:1px solid rgb(241, 241, 241)">
            ...
            <form action="{{ route('teachers.store') }}" class="form" method="POST" enctype="multipart/form-data">
                @csrf
                ...
                <div class="row py-3">
                    ...
                    <div class="form-group col-md-4">
                        ...
                        @enderror"
                            name="contact_number" id="con" placeholder="Enter contact number" value="{{ old('contact_number')}}">
                ...
                <div class="row py-3">
                    <div class="form-group col-md-4">
                        ...
                        @enderror"name="academic_post"
                            id="post" placeholder="Enter academic post" value="{{    old('academic_post')}}">
                        @error('faculty_id')
                            <p class="invalid-feedback">{{ $message }}</p>
                        @enderror
                    </div>
